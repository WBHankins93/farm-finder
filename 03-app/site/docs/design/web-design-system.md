...
- **Display/editorial:** Plus Jakarta Sans, restrained to large titles, farm names, and explanatory prose.
- **Interface/data:** DM Sans, used for navigation, filters, counts, labels, and controls.
