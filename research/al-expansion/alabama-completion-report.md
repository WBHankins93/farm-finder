...
| Website present | 272 entities (32.0%) |
| Any retained social URL | 418 entities (49.2%) |
...
multi-source group are in `identity-review.csv`.
...
observations remain in `excluded-observations.csv`.
